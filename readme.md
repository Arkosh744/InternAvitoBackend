...
5) Метод признания выручки - реализован как метод подтверждения заказа на покупку услуги или отклонения заказа (и возвращение средств на основной баланс кошелька пользователя).
